...
object HimP1HumanReviewSemanticContractV2 {
    ...
    const val SECONDARY_ANALYSIS_TYPE = "AI_SEMANTIC_ENRICHMENT"
    const val SECONDARY_ANALYSIS_PROVIDER = "ChatGPT / OpenAI model"
    const val SECONDARY_ANALYSIS_IS_HUMAN = false
    const val SECONDARY_ANALYSIS_IS_INDEPENDENT_HUMAN_VALIDATION = false
    const val SECONDARY_ANALYSIS_IS_SAME_REVIEWER_SECOND_PASS = false
    const val SECONDARY_ANALYSIS_IS_TEMPORAL_HUMAN_CONSISTENCY_CHECK = false
