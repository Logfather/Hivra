...
object CanonicalFirstGeneralizedSemanticPolicyWaveImpactReference {
    ...
    fun validate(
        ...
        require(analysis.batchKey == WAVE_KEY)
        ...
        require(analysis.reviewRequiredDelta == -336)
        ...
        require(analysis.materializedEntryDelta == 97)
