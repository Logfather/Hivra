...
class CanonicalSecondSemanticPolicyBatchApplier(
    private val factory:
        ...
        return when {
            ...
            existingEntries.size ==
                ...
                require(
                    ...
                    "Second semantic policy batch is already present, " +
                ...
                error(
                    "Second semantic policy batch is only partially applied. " +
    ...
    private fun applyPendingBatch(
        ...
        val selectedBatch =
            requireNotNull(
                ...
                "Expected second semantic policy batch is missing, " +
        ...
        require(
            ...
            "Unexpected second-batch category: " +
                    selectedBatch.category
        }
        ...
        require(
            ...
            "Unexpected second-batch gap count: " +
                    selectedBatch.gapCount
        }
        ...
        require(
            ...
            "Curated policies do not exactly cover the selected second batch."
        }
