...
class CanonicalCatalogExpansionSemanticValidationWriter(
    ...
    fun write(
        ...
        require(result.valid) {
            "Cannot persist invalid semantic validation result: " +
        ...
        if (!outputDirectory.exists()) {
            require(outputDirectory.mkdirs()) {
                "Could not create semantic validation directory: " +
