...
class CanonicalProductFamilyCoverageWriter(
    private val gson: Gson =
        createDefaultGson()
) {

    fun write(
        coverage: CanonicalProductFamilyCoverage,
        outputFile: File
    ) {
        require(coverage.valid) {
            "Cannot persist invalid product-family coverage: " +
        ...
        if (!outputDirectory.exists()) {
            require(outputDirectory.mkdirs()) {
                "Could not create product-family output directory: " +
