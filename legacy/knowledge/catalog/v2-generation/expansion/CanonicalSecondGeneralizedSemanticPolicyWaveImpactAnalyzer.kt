...
class CanonicalSecondGeneralizedSemanticPolicyWaveImpactAnalyzer(
    ...
    fun analyze(
        ...
        wavePolicies.forEach { expected ->
            require(
                ...
                "Wave-2 policy is missing or divergent: " +
                        expected.identityKey
            }
        }
        ...
        val blockers =
            buildList {
                ...
                if (!reviewBacklogReduced) {
                    add(
                        "Second generalized policy wave did not reduce " +
                                "the review backlog."
                    )
                }
                ...
                if (!policyExpansionValid) {
                    add(
                        "Wave-2 policy deltas are inconsistent: " +
