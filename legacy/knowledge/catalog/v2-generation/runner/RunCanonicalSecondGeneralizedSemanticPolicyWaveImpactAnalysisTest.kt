...
import de.shopme.testing.system.tools.knowledge.catalog.expansion.semantic.impact.CanonicalSecondGeneralizedSemanticPolicyWaveImpactAnalyzer
import de.shopme.testing.system.tools.knowledge.catalog.expansion.semantic.impact.CanonicalSecondGeneralizedSemanticPolicyWaveImpactBaselineFactory
import de.shopme.testing.system.tools.knowledge.catalog.expansion.semantic.impact.CanonicalSecondGeneralizedSemanticPolicyWaveImpactReference
...
class RunCanonicalSecondGeneralizedSemanticPolicyWaveImpactAnalysisTest {

    @Test
    fun analyzeSecondGeneralizedSemanticPolicyWaveImpact() {
        ...
        val expectedBaseline =
            CanonicalSecondGeneralizedSemanticPolicyWaveImpactBaselineFactory()
                .create()
        ...
        val baseline =
            if (
                ...
                require(
                    ...
                    "Persisted Wave-2 impact baseline has changed."
                }
        ...
        val analysis =
            CanonicalSecondGeneralizedSemanticPolicyWaveImpactAnalyzer()
                .analyze(
                    baseline =
                        baseline,
    ...
    private fun printAnalysis(
        ...
        println(
            buildString {
                appendLine(
                    "Second generalized semantic policy wave impact"
                )
                appendLine(
                    "----------------------------------------------"
                )
    ...
    private companion object {
        ...
        const val IMPACT_BASELINE_PATH =
            "data/generated/knowledge/catalog/expansion/impact/" +
                    "canonical-second-generalized-wave-impact-baseline.json"
