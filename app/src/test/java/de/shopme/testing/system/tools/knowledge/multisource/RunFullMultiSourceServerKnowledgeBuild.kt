...
object RunFullMultiSourceServerKnowledgeBuild {
    ...
    fun main(args: Array<String>) {
        ...
        require(offFile.isFile) {
            "OFF source file does not exist: ${offFile.absolutePath}"
        }

        require(agribalyseFile.isFile) {
            "Agribalyse source file does not exist: ${agribalyseFile.absolutePath}"
        }
        ...
        return candidates
            ...
            ?: error(
                buildString {
                    ...
                    append(
                        "Pass the complete CIQUAL source directory as " +
                                "the third runner argument."
                    )
                }
            )
    }
    ...
    private fun printResult(
        ...
        println("Normalized candidates=${result.normalizedCandidateCount}")
        println("Merged candidates=${result.mergedCandidateCount}")
