...
class RunHimPositiveSingleItemTeacherPilotSelectionV1Test {
    ...
    private companion object {
        ...
        const val SELECTION_ARTIFACT_PATH = "$TRAINING_DIRECTORY/him-positive-single-item-teacher-paid-pilot.selection.v1.r3.json"
    ...
    @Test fun `selection entrypoint keeps the real artifact path separate from the legacy mission`() {
        assertEquals(
            "build/knowledge/reports/him/training/him-positive-single-item-teacher-paid-pilot.selection.v1.r3.json",
