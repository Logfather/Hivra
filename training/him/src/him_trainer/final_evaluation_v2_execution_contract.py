...
def build_execution_contract() -> dict[str, Any]:
    inputs = [
        ...
        {"id": "sealed_review_packet", "type": "json", "path": "<evaluation-root>/review-packet.v2.json", "requiredBeforeExecution": True, "requiredBeforeExposure": True, "validatedBy": "_load_native_sealed_root_v2", "consumedBy": "_load_native_sealed_root_v2"},
        {"id": "sealed_ground_truth", "type": "json", "path": "<evaluation-root>/ground-truth.v2.json", "requiredBeforeExecution": True, "requiredBeforeExposure": True, "validatedBy": "_load_native_sealed_root_v2", "consumedBy": "_load_native_sealed_root_v2"},
        {"id": "sealed_evaluation_authority", "type": "json", "path": "<evaluation-root>/sealed-evaluation-authority.v2.json", "requiredBeforeExecution": True, "requiredBeforeExposure": True, "validatedBy": "_load_native_sealed_root_v2", "consumedBy": "_load_native_sealed_root_v2"},
        {"id": "sealed_final_validation_report", "type": "json", "path": "<evaluation-root>/final-validation-report.v2.json", "requiredBeforeExecution": True, "requiredBeforeExposure": True, "validatedBy": "_load_native_sealed_root_v2", "consumedBy": "_load_native_sealed_root_v2"},
        ...
        {"id": "input_representation", "type": "derived-execution-field", "path": "<evaluation-root>/derived-execution-artifact.v1.json:modelInputs[].serialized", "requiredBeforeExecution": True, "requiredBeforeExposure": True, "validatedBy": "_native_model_input_rows", "consumedBy": "_native_model_input_rows"},
