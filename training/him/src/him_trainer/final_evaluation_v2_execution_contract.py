...
def build_execution_contract() -> dict[str, Any]:
    inputs = [
        ...
        {"id": "input_representation", "type": "sealed-field", "path": "<evaluation-root>/ground-truth.v2.json:modelInput.serialized", "requiredBeforeExecution": True, "requiredBeforeExposure": True, "validatedBy": "_native_model_input_rows", "consumedBy": "_native_model_input_rows"},
