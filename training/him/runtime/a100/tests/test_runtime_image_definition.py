...
EXPECTED_RUNTIME_SOURCE_FILES = {
    ...
    "training/him/src/him_trainer/blind_expanded_validation_v2.py",
    ...
    "training/him/src/him_trainer/v3_prediction_adapter.py",
    "training/him/src/him_trainer/v3_recovery_evaluation.py",
    ...
    "training/him/src/him_trainer/final_evaluation_v2_execution_contract.py",
    "training/him/src/him_trainer/final_training_runtime_closure_v1.py",
    "training/him/src/him_trainer/input_representation_v2.py",
    "training/him/src/him_trainer/input_representation_v3.py",
    ...
    "training/him/src/him_trainer/productive_retraining_v3.py",
    "training/him/src/him_trainer/productive_development_v3.py",
    "training/him/src/him_trainer/retraining_authority_materialization_v1.py",
    "training/him/src/him_trainer/productive_training_v2.py",
...
class RuntimeImageDefinitionTest(unittest.TestCase):
    ...
    def test_manifest_is_bounded_and_deterministic(self) -> None:
        self.assertEqual(len(self.manifest_rows), 67)
    ...
    def test_manifest_binds_unchanged_him_trainer_package(self) -> None:
        ...
        self.assertEqual(len(package_rows), 46)
        self.assertEqual(
    ...
    def test_runtime_identity_is_offline_observable_and_digest_derived(self) -> None:
        ...
        self.assertEqual(self.identity["runtimeSourceClosure"]["fileCount"], 46)
        self.assertEqual(
    ...
    def test_final_training_packet_is_clean_environment_bound(self) -> None:
        ...
        self.assertIn(
            "COPY training/him/runtime/a100/final-evaluation-authority-v1 /opt/him/training/him/runtime/a100/final-evaluation-authority-v1",
            self.dockerfile,
        )
