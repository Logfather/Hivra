...
def _write_lineage(path: Path, mode: str, facts: dict[str, Any]) -> None:
    ...
    lineage = {
        ...
        "buildDefinitionDigest": identity.get("buildDefinitionDigest"),
        "dependencyLockDigest": identity.get("dependencyLockDigest"),
        "sourceGitHead": identity.get("sourceGitHead"),
        "runtimeSourceLogicalDigest": identity.get("runtimeSourceLogicalDigest"),
        "sourceTreeFileDigests": identity.get("sourceTreeFileDigests"),
